...
const configDefinitions: Record<ConfigKey, { title: string; path: string; mkdir?: string; blocks: ConfigBlock[] }> = {
  [CONFIG_KEYS.ZSHRC]: {
    title: ".zshrc",
    path: "$HOME/.zshrc",
...
const pluginNoteFor = (configKey: ConfigKey, blockId: string) => {
