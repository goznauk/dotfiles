...
const readInitialView = (): ViewId => {
  ...
  return view === "target" || view === "packages" || view === "toolchains" || view === "configs" || view === "summary"
    ? view
    : "target";
};
...
const readInitialConfig = (): ConfigKey => {
  ...
  return config === "vimrc" || config === "tmux" || config === "htop" || config === "zshrc" ? config : "zshrc";
};
...
export function App() {
  ...
  const dockerStrategies = useMemo(() => catalog.strategies.docker.filter((strategy) => strategy.id !== "none"), []);
  const nodeStrategies = useMemo(() => catalog.strategies.node.filter((strategy) => strategy.id !== "none"), []);
  const pythonStrategies = useMemo(() => catalog.strategies.python.filter((strategy) => strategy.id !== "none"), []);
  const javaStrategies = useMemo(() => catalog.strategies.java.filter((strategy) => strategy.id !== "none"), []);
